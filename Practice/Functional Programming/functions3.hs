...
-- функция size, която намира броя на елементите на двоично дърво

size :: BTree -> Int
size Empty = 0
size (Node n left right) = 1 + size left + size right

-- функция height, която намира височината на двоично дърво

height :: BTree -> Int
height Empty = 0
height (Node _ left right) = 1 + max (height left) (height right)

-- функция sumTree, която намира сумата от елементите на двоично дърво

sumTree :: BTree -> Int
sumTree Empty = 0
sumTree (Node n left right) = n + sumTree left + sumTree right

-- функция sumLeaves, която намира сумата елементите по листата на двоично дърво
...
-- функция inorder, която обхожда двоично дърво в ред Ляво-Корен-Дясно

inorder :: BTree -> [Int]
inorder Empty = []
inorder (Node n left right) = (inorder left) ++ [n] ++ (inorder right)

-- Да се дефинира функция getLevel :: getLevel :: Int -> BTree -> [Int], която намира елементите на k-то ниво на двоично дърво.
